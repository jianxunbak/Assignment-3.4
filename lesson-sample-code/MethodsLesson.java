public class MethodsLesson {
  public static void main(String args[]) {
     ...
     * the example in main, sum is called with values 1 and 3. Variables can also be
  ...
  /*
   * In this example, the method is called sum and it needs two integers to
   * operate. It would then return the result of the operation x + y.

   * When there is no need for a method to have a return value, the "void" keyword
   * can be used. 
   */
